...
local Window = OrionLib:MakeWindow({Name = "AFXCAXI HUB", HidePremium = false, SaveConfig = true, ConfigFolder = "HyperVersion"})
...
SettingsTab:AddLabel("I asked Hirimi for permission and he let me use it and I credited the source") 

SettingsTab:AddLabel("https://www.youtube.com/channel/UCppExFlPUorGZNKXp8GFtmw") 

SettingsTab:AddLabel("Join For Discord") 

SettingsTab:AddLabel("https://discord.gg/GDpSnER5cD") 
