...
function Update:Window(text,logo,keybind)
	...
	local RINHUB = Instance.new("ScreenGui")
	RINHUB.Name = "RIN HUB"
	RINHUB.Parent = game.CoreGui
	RINHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
--------------------------------------------------------------------
local Library = Update:Window("RIN HUB","")
------------------------------------------
...
Setting:Button("Copy Discord Link",function()
 ...
 setclipboard("https://discord.gg/mWZZa3Y2nY")
 end)
...
wait(1)
Notification:Notify(
   {Title = "RIN HUB", Description = "You Have Max Observation"},
